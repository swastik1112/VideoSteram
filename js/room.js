...
const socket = io();
// Video element where local video stream will be displayed
...
// Overlay elements for username input
...
// Hide whiteboard container initially
...
// Function to fit canvas to its container
...
// Event to receive the current canvas state from the server
...
// Event to clear the whiteboard based on server notification
...
// Function to draw on the canvas based on remote user's input
...
// Event to handle remote drawing input
...
// Video and audio control variables
let videoAllowed = 1;
let audioAllowed = 1;
...
// Objects to manage peer connections and tracks
let connections = {};
let cName = {};
let audioTrackSent = {};
let videoTrackSent = {};
...
// Event to handle joining the room
...
// Event to handle pressing Enter to join room
...
// Event to update video container class based on user count
...
// Function to handle video offer
